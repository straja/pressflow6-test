 ...
 */
function diwanee_theme(&$existing, $type, $theme, $path) {
  if (!db_is_active()) {
    return array();
  }
 ...
 */
function diwanee_preprocess_page(&$vars) {
  global $user;
 ...
 *   A sequential array of variables passed to the theme function.
 */
function diwanee_preprocess_node(&$vars, $hook) {
 ...
 *   A sequential array of variables passed to the theme function.
 */
function diwanee_preprocess_comment(&$vars) {
 ...
 */
function diwanee_preprocess_block(&$vars, $hook) {
  $block = $vars['block'];
 ...
 *   A sequential array of variables passed to the theme function.
 */
function diwanee_preprocess_box(&$vars) {
 ...
 */
function diwanee_username($object) {
 ...
 */
function diwanee_breadcrumb($breadcrumb) {
 ...
 */
function diwanee_form_element($element, $value) {
  $args = func_get_args();
 ...
 */
function diwanee_status_messages($display = NULL) {
  $output = '';
 ...
 */
function diwanee_comment_wrapper($content, $node) {
  global $user;
  $output = '';
 ...
 */
  ...
  function diwanee_forum_icon($new_posts, $num_posts = 0, $comment_mode = 0, $sticky = 0) {
 ...
 */
function diwanee_forum_topic_navigation($node) {
  return '';
}
}
 ...
 */
function diwanee_trim_text($text, $length = 150) {
 ...
 * weighted styles.
 */
function diwanee_css_reorder($css) {
